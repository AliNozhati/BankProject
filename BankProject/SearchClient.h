...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(SearchClient::typeid));
			...
			this->cancel_btn->Location = System::Drawing::Point(262, 156);
			...
			this->cancel_btn->Click += gcnew System::EventHandler(this, &SearchClient::cancel_btn_Click);
			// 
			// search_btn
			// 
			...
			this->search_btn->Location = System::Drawing::Point(88, 156);
			...
			this->search_btn->Click += gcnew System::EventHandler(this, &SearchClient::search_btn_Click);
			// 
			// lbl1
			// 
			...
			this->lbl1->ForeColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(66)), static_cast<System::Int32>(static_cast<System::Byte>(133)),
				static_cast<System::Int32>(static_cast<System::Byte>(236)));
			this->lbl1->Location = System::Drawing::Point(24, 73);
...
#pragma endregion
	private: System::Void search_btn_Click(System::Object^ sender, System::EventArgs^ e)
	{
		// do sth
		// if find
		int64_t nationalCode = int64_t::Parse(this->nationalCode_txt->Text);
		Client* client = employee->getClient(nationalCode);///?????
