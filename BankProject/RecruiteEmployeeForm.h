...
namespace BankProject {
	...
	/// <summary>
	/// Summary for RecruiteEmployeeForm
	/// </summary>
	public ref class RecruiteEmployeeForm : public System::Windows::Forms::Form
	{
	public:
		RecruiteEmployeeForm(Manager* m)
		{
			InitializeComponent();
			manager = m;
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(RecruiteEmployeeForm::typeid));
			...
			this->Add_btn->Location = System::Drawing::Point(339, 490);
			...
			this->Add_btn->Click += gcnew System::EventHandler(this, &RecruiteEmployeeForm::Add_btn_Click);
			// 
			// timePicker
			// 
			...
			this->timePicker->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 15, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->timePicker->Format = System::Windows::Forms::DateTimePickerFormat::Short;
			this->timePicker->Location = System::Drawing::Point(192, 172);
			this->timePicker->Name = L"timePicker";
			this->timePicker->Size = System::Drawing::Size(228, 41);
			this->timePicker->TabIndex = 53;
			// 
			// password_txt
			// 
			...
			this->password_txt->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->password_txt->ForeColor = System::Drawing::Color::White;
			this->password_txt->Location = System::Drawing::Point(192, 364);
			...
			this->username_txt->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->username_txt->ForeColor = System::Drawing::Color::White;
			this->username_txt->Location = System::Drawing::Point(192, 301);
			this->username_txt->Name = L"username_txt";
			this->username_txt->Size = System::Drawing::Size(228, 41);
			this->username_txt->TabIndex = 51;
			...
			this->lastname_txt->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lastname_txt->ForeColor = System::Drawing::Color::White;
			this->lastname_txt->Location = System::Drawing::Point(192, 114);
			...
			this->name_txt->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 15, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->name_txt->ForeColor = System::Drawing::Color::White;
			this->name_txt->Location = System::Drawing::Point(192, 54);
			...
			this->back_pic->Location = System::Drawing::Point(438, 3);
			...
			this->back_pic->TabIndex = 47;
			this->back_pic->TabStop = false;
			this->back_pic->Click += gcnew System::EventHandler(this, &RecruiteEmployeeForm::back_pic_Click);
			// 
			// panel
			// 
			...
			this->panel->Size = System::Drawing::Size(175, 547);
			...
			this->lbl6->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(66)), static_cast<System::Int32>(static_cast<System::Byte>(133)),
				static_cast<System::Int32>(static_cast<System::Byte>(236)));
			this->lbl6->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lbl6->ForeColor = System::Drawing::Color::White;
			this->lbl6->Location = System::Drawing::Point(25, 376);
			...
			this->lbl1->Location = System::Drawing::Point(25, 61);
			...
			this->lbl4->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(66)), static_cast<System::Int32>(static_cast<System::Byte>(133)),
				static_cast<System::Int32>(static_cast<System::Byte>(236)));
			this->lbl4->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lbl4->ForeColor = System::Drawing::Color::White;
			this->lbl4->Location = System::Drawing::Point(25, 251);
			...
			this->lbl3->Location = System::Drawing::Point(25, 182);
			...
			this->lbl2->Location = System::Drawing::Point(25, 126);
			...
			this->lbl5->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(66)), static_cast<System::Int32>(static_cast<System::Byte>(133)),
				static_cast<System::Int32>(static_cast<System::Byte>(236)));
			this->lbl5->Font = (gcnew System::Drawing::Font(L"Yu Gothic UI", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lbl5->ForeColor = System::Drawing::Color::White;
			this->lbl5->Location = System::Drawing::Point(25, 313);
			...
			this->ClientSize = System::Drawing::Size(468, 547);
			...
			this->Name = L"RecruiteEmployeeForm";
...
#pragma endregion
	...
	private: System::Void Add_btn_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		manager->employeeRecruitment(name, lastname, bdate, nCode, user, pass);
		this->Close();
	}
};
}
